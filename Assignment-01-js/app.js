...
var birthYear = 1999 +'<br>';
document.write("My birth year is " + birthYear + "<br>");
document.write("Data type of my declared variable is number"+'<br>');
var visitorName = "AHMED RAZA"+'<br>';
var productTitle = "T-shirt"+'<br>';
 var quantity = 5;
...
if ( !isNaN(number)) {
  console.log("Aapka number hai:", number +'<br>');
} else {
  console.log("Invalid input. Kripya sahi number dalen."+'<br>');
}
